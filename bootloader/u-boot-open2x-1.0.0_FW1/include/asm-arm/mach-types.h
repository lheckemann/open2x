...
#ifdef CONFIG_ARCH_EPLAY
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_EPLAY
# endif
# define machine_is_eplay()	(machine_arch_type == MACH_TYPE_EPLAY)
#else
# define machine_is_eplay()	(0)
#endif
