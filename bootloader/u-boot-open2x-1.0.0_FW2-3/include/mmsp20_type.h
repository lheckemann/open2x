...
/* FRAME Dimension Converter : oyh modified */
typedef struct {
...
// SD INTERFACE (see MMSP2 manual chapter 27)
	...
	S3C24X0_REG32	SDIIMSK;  // Changed by Salamander --> 0x5a00003c
#ifdef __BIG_ENDIAN
	S3C24X0_REG32	res[3];   // Changed by Salamander
	S3C24X0_REG32	SDIDAT;   // Changed by Salamander --> 0x5a00004c
#else // Littel Endian
	S3C24X0_REG32	SDIDAT;   // Changed by Salamander --> 0x5a000040
	S3C24X0_REG32	res[3];	  // Changed by Salamander
*/
...
typedef struct
{
	...
	MMSP20_REG32	SDIRSP3		;	// bSDI32(0x18)	/* SDI Response Register 3 */

	MMSP20_REG16	SDIBSIZE	;	// bSDI(0x1E)	/* SDI Block Size Register */
	MMSP20_REG32	SDIDCON		;	// bSDI32(0x20)	/* SDI Data Control Register */
	MMSP20_REG32	SDIDCNT		;	// bSDI32(0x24)	/* SDI Data Remain Counter Register */
	MMSP20_REG16	SDIDSTA		;	// bSDI(0x28)	/* SDI Data Status Register */
...
/*
	...
	MMSP20_REG16	SDICCON;	// 1508h
	MMSP20_REG16	SDICSTA;	// 150Ah
	MMSP20_REG16	SDIRSP0;	// 150Ch
	MMSP20_REG16	SDIRSP1;	// 150Eh
	MMSP20_REG16	SDIRSP2;	// 1510h
	MMSP20_REG16	SDIRSP3;	// 1512h
	MMSP20_REG16	SDIRSP4;	// 1514h
	MMSP20_REG16	SDIRSP5;	// 1516h
	MMSP20_REG16	SDIRSP6;	// 1518h
	MMSP20_REG32	SDIRSP7;	// 151Ah
	MMSP20_REG32	SDIBSIZE;	// 151Eh
	MMSP20_REG16	SDIDCON;	// 1520h, 1522h
	MMSP20_REG16	SDIDCNT;	// 1524h, 1526h
	MMSP20_REG32	SDIDSTA;	// 1528h
	MMSP20_REG16	SDIFSTA;	// 152Ah
	MMSP20_REG16	SDIDAT;   	// 152Ch
	MMSP20_REG16	SDIIMSK0;  	// 1530h
