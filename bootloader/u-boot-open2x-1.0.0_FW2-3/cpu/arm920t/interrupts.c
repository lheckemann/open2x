...
typedef struct irqcont {
	volatile unsigned long SRCPEND;
	volatile unsigned long INTMODE;
	volatile unsigned long INTMASK;
	volatile unsigned long PRIORIT;
	volatile unsigned long INTPEND;
...
void do_irq (struct pt_regs *pt_regs)
{
	...
	IRQReg->SRCPEND	|= (unsigned long)(1 << 19);			// Clear SRCPENDREG
	IRQReg->INTPEND	|= (unsigned long)(1 << 19);			// Clear INTPENDREG
