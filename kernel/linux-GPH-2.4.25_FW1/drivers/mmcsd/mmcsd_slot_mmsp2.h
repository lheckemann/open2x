...
#ifndef MMCSD_MMSP2_H
#define MMCSD_MMSP2_H
...
#define SDIIMSK1	bSDI32(0x30)	/* SDI Interrupt Mask Register 1 */
#define SDIIMSK0	bSDI32(0x32)	/* SDI Interrupt Mask Register 0 */
...
#if defined(CONFIG_S3C2440A_SMDK) || defined(CONFIG_S3C24A0A_SMDK) || defined(CONFIG_MACH_MMSP2_MDK) /* only for 24X0A version*/
...
#define MMC_NORCLK		15000000	/* 15 MHz */
#define SD_NORCLK		25000000	/* 25 MHz 	SDIPRE == 2 */	
#if 0
#define MMCSD_INICLK		25000000	/* 25 MHz */
#else
...
#endif
#if 1
#define NO_CD_IRQ		// Disable card detect interrupt
#else
#undef	NO_CD_IRQ		// Enable card detect interrupt
#endif
