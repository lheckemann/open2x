/*
 * drivers/usb/host/usb-ohci-mmsp2.c
 *
 ...
 *
 * OHCI r1.0 compatible, CPU embedded USB host controller driver for Magiceyes MMSP2
 *
 * $Id$
 *
 * Revision History:
 *
 * 2004-05-10 SeonKon Choi <bushi@mizi.com>
 * - initial version
 *
 */
