...
#define SMC_IOADDR		(MDK_ETH_PIO_BASE)
#define SMC_IRQ			IRQ_ETHER
...
static int smc_read_phy_register(unsigned long ioaddr, int phyaddr, int phyreg);
static void smc_write_phy_register( unsigned long ioaddr, int phyaddr, int phyreg, int phydata );
