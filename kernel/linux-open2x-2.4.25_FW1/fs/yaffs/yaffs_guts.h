 ...
 *
 * $Id: yaffs_guts.h,v 1.1.6.1 2003/10/16 19:01:57 bushi Exp $
 */
...
typedef struct
{
	...
	__u32 st_atime_; // time of last access
	__u32 st_mtime_; // time of last modification
	__u32 st_ctime_; // time of last change
#endif
