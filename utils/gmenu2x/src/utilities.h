...
#include <fstream>
//senquack - needed for getDiskFree:
#include <sstream>
...
//senquack - new function to find out if SD is inserted or not (Open2X supports SD removal/
//		insertion because it runs off the NAND)
bool isSDInserted(void);
	
//senquack - moved here from GMenu2X class
string getDiskFree(void);
	
//senquack - new function to detgrmine whether SD is currently mounted to /mnt/sd
