...
/*
 ...
 They don't form part of SDL_Config API, rather than are used by test programs, to automatically
...
#define CFG_AUTO_TEST_FLOAT(x, y) if ((x - y) > 0.000001 ) \
