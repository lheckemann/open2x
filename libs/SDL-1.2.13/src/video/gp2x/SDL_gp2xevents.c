...
//DKS - these were already in here:
...
*/
//DKS - pulled this from fbcon for USB keyboard support
...
//DKS - pulled from GPH's and modified
...
//DKS - pulled from virgin SDL 1.2.9 fbcon/ and modified
