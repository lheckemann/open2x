...
# This is a script to build and install the GP2X/ARM patched PNG lib found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building libPNG for the GP2X"
echo " "
...
then
  ...
  echo "-   This library is not being built. BUILD_LIBPNG = $BUILD_LIBPNG"
  exit
