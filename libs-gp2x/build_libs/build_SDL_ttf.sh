...
# This is a script to build and install the GP2X patched SDL_ttf lib found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building SDL_ttf 2.0.7 for the GP2X"
echo " "
...
then
  ...
  echo "-   This library is not being built. BUILD_SDL_TTF = $BUILD_SDL_TTF"
  exit
