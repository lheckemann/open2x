...
# This is a script to build and install the GP2X/ARM patched OGG Vorbis Tremor lib found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building libTremor for the GP2X"
echo " "

if [ $BUILD_LIBTREMOR = 1 ]
then
  ...
  echo "-   This library is not being built. BUILD_LIBTREMOR = $BUILD_LIBTREMOR"
  exit
