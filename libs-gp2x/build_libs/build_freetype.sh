...
# This is a script to build and install the FreeType TrueType font lib (used by SDL_ttf) found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building FreeType 2.1.10"
echo " "
...
then
  ...
  echo "-   This library is not being built. BUILD_FREETYPE = $BUILD_FREETYPE"
  exit
