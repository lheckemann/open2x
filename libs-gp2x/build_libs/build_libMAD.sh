...
# This is a script to build and install the GP2X/ARM patched MAD MP3 playback lib found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building libMAD for the GP2X"
echo " "
...
then
  ...
  echo "-   This library is not being built. BUILD_LIBMAD = $BUILD_LIBMAD"
  exit
