...
# This is a script to build and install the GP2X patched SDL_image lib found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building SDL_image 1.2.4 for the GP2X"
echo " "

if [ $BUILD_SDL_IMAGE = 1 ]
then
  ...
  echo "-   This library is not being built. BUILD_SDL_IMAGE = $BUILD_SDL_IMAGE"
  exit
