...
# This is a script to build and install the ID3TAG reading lib (tied to libMAD) found in the Open2x libs_gp2x CVS module.

echo " "
echo "*  Building libID3TAG for the GP2X"
echo " "

if [ $BUILD_LIBID3TAG = 1 ]
then
  ...
  echo "-   This library is not being built. BUILD_LIBID3TAG = $BUILD_LIBID3TAG"
  exit
