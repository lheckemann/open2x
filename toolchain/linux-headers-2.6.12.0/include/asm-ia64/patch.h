...
extern void ia64_patch (__u64 insn_addr, __u64 mask, __u64 val);	/* patch any insn slot */
extern void ia64_patch_imm64 (__u64 insn_addr, __u64 val);		/* patch "movl" w/abs. value*/
extern void ia64_patch_imm60 (__u64 insn_addr, __u64 val);		/* patch "brl" w/ip-rel value */
