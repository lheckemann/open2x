...
/* SBI */
struct sbi_regs {
/* 0x0000 */	__u32		cid;		/* Component ID */
/* 0x0004 */	__u32		ctl;		/* Control */
/* 0x0008 */	__u32		status;		/* Status */
		__u32		_unused1;
		
/* 0x0010 */	__u32		cfg0;		/* Slot0 config reg */
/* 0x0014 */	__u32		cfg1;		/* Slot1 config reg */
/* 0x0018 */	__u32		cfg2;		/* Slot2 config reg */
/* 0x001c */	__u32		cfg3;		/* Slot3 config reg */

/* 0x0020 */	__u32		stb0;		/* Streaming buf control for slot 0 */
/* 0x0024 */	__u32		stb1;		/* Streaming buf control for slot 1 */
/* 0x0028 */	__u32		stb2;		/* Streaming buf control for slot 2 */
/* 0x002c */	__u32		stb3;		/* Streaming buf control for slot 3 */

/* 0x0030 */	__u32		intr_state;	/* Interrupt state */
/* 0x0034 */	__u32		intr_tid;	/* Interrupt target ID */
/* 0x0038 */	__u32		intr_diag;	/* Interrupt diagnostics */
};
