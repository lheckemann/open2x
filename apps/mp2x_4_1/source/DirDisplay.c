...
void OnDrawDirectory(SDL_Surface *pScreen, SDL_Surface *pImgScreen, SViewInfomation infoView, SDirInfomation *infoDirList)
{
	...
	//senquack - fixing selectbar... GPH had it here as just a slim line and it looks crappy.. making 
	//		it instead be a 280x20 image, alpha blended to be translucent
	SDL_SetAlpha( pImg_Line, SDL_SRCALPHA, 100 );
