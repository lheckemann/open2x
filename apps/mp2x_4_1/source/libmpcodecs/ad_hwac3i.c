...
#include "../liba52/ia52.h" // ghcstop


static ia52_state_t *a52_state; // ghcstop
...
static int ac3dts_fillbuff(sh_audio_t *sh_audio)
{
  ...
  while(1)
  {
    ...
    length = ia52_syncinfo(sh_audio->a_in_buffer, &flags, &sample_rate, &bit_rate); // ghcstop
